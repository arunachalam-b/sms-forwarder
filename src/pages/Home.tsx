...
const Home: React.FC = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-indigo-50 via-white to-indigo-50 py-24">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href="#features"
                  className="inline-flex items-center justify-center border-2 border-indigo-600 text-indigo-600 px-6 py-3 rounded-lg font-semibold hover:bg-indigo-50 transition-colors"
                >
                  Learn More
                </a>
              </div>
            ...
            <div className="md:w-1/2 relative">
              <div className="relative z-10 rounded-xl shadow-2xl overflow-hidden border-8 border-white max-w-sm mx-auto">
                <img
      ...
      <section className="py-20 bg-white" id="privacy-comparison">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">Your Privacy Matters</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div className="bg-gray-100 rounded-2xl p-8 relative">
              ...
              <ul className="space-y-4 mt-6">
                <li className="flex items-start">
                  ...
                  <span>Access all your messages without explicit permission</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-red-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path>
                  </svg>
                  <span>May store your message data on their servers</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-red-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path>
                  </svg>
                  <span>Could share your message content with third parties</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-red-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path>
                  </svg>
                  <span>Continue tracking in background without your knowledge</span>
                </li>
              </ul>
            ...
            <div className="bg-indigo-50 rounded-2xl p-8 relative">
              ...
              <ul className="space-y-4 mt-6">
                <li className="flex items-start">
                  ...
                  <span>Only accesses messages when you grant permission</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span>All data stays locally on your device</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span>We never share your message data - what's yours stays yours</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span>Full transparency - only forwards what you explicitly configure</span>
                </li>
              </ul>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-start">
              <div className="bg-indigo-100 p-4 rounded-2xl mb-4 md:mb-0 md:mr-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Forward only the messages that matter with custom filters based on sender, content, or keywords. Keep the noise out.</p>
              </div>
            </div>

            <div className="flex flex-col md:flex-row items-start">
              <div className="bg-green-100 p-4 rounded-2xl mb-4 md:mb-0 md:mr-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Your data never leaves your device. We don't store your messages on our servers or share them with third parties.</p>
              </div>
            </div>

            <div className="flex flex-col md:flex-row items-start">
              <div className="bg-purple-100 p-4 rounded-2xl mb-4 md:mb-0 md:mr-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Designed to be light on resources while running in the background. Forward messages without draining your battery.</p>
              </div>
            </div>

            <div className="flex flex-col md:flex-row items-start">
              <div className="bg-yellow-100 p-4 rounded-2xl mb-4 md:mb-0 md:mr-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Configure your forwarding rules in minutes with our intuitive interface. No technical knowledge required.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center text-xl font-bold text-indigo-600 mr-4">
                  JD
                </div>
                <div>
            ...
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center text-xl font-bold text-green-600 mr-4">
                  SA
                </div>
                <div>
                  <h4 className="font-bold">Sarah A.</h4>
                  <div className="text-yellow-400">★★★★★</div>
                </div>
              </div>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center text-xl font-bold text-purple-600 mr-4">
                  MK
                </div>
                <div>
                  <h4 className="font-bold">Mike K.</h4>
                  <div className="text-yellow-400">★★★★★</div>
                </div>
              </div>
              <p className="text-gray-600">
      ...
      <section className="py-20 bg-indigo-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <a
            href="[Your Google Play Store Link]"
            className="inline-flex items-center justify-center bg-white text-indigo-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg"
          >
            <svg className="w-6 h-6 mr-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.53,12.9 20.18,13.18L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z" />
            </svg>
